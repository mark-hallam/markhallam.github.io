...
Prompt Compilation v3.0 leverages both Opus 4.6 and Sonnet 4.6 to optimize cost and quality across the execution DAG.
...
In GYSOM v2, the compiler would stop after each phase and wait for the human to say "proceed" or "looks good, continue." This created 4-5 unnecessary round-trips per project. Prompt Compilation v3.0 eliminates ALL intermediate stops.
...
- Prompt Compilation v3.0 requires exactly **2 human messages**: (1) project description, (2) decision batch response
...
| v3.0 | Prompt Compilation | Model routing, effort-aware dispatch, autonomous orchestration, cost tracking, autonomous phase progression | 2026 |

The methodology's evolution is documented at:
- GYSOM v1/v2: [github.com/mark-hallam/gysom](https://github.com/mark-hallam/gysom)
- Prompt Compilation v3.0: [github.com/mark-hallam/markhallam-website](https://github.com/mark-hallam/markhallam-website)
...
Prompt Compilation v3.0. Compile intent. Execute autonomously.
